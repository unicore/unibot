...
const quizDefinition = [
  { message: 'Contacts' },
  { message: 'Давай познакомимся! Пожалуйста, расскажи кратко о себе и своих навыках в разработке ПО?' },
  ...
  bot.start(async (ctx) => {
    ...
    if (ctx.update.message.chat.type === 'private') {
      if (!ctx.update.message.from.is_bot) {
        ...
        const t = 'Добро пожаловать в элитный клуб. 🔯\n\nВсе крупные мировые компании активно внедряют блокчейн, а разработчиков, кто в этом хоть что-то понимает - почти нет, и это тормозит прогресс. 😥\n\nМы предлагаем тебе войти в ряды инженеров-исследователей, обладающих навыком запуска корпоративных блокчейнов для сообществ и бизнеса. 📟 \n\nВ нашем клубе ты:\n- Научишься проектировать и запускать выделенный блокчейн с цифровой экономикой 🔗\n- Научишься писать смарт-контракты с бизнес-логикой любой сложности 💻\n- Научишься создавать интерфейсы для работы со своими смарт-контрактами 👨‍🎨\n\nОбучение проходит в формате еженедельных видео-уроков с самостоятельным заданием, за выполнение которого, выдаются ценные NFT. По завершению обучения, ты получишь сертификат на блокчейне с подтверждением пройденного пути и возможность трудоустройства в клуб или к партнёрам клуба 🌀';
