...
async function nextQuiz(bot, user, ctx) {
  ...
  if (q) {
    ...
    const id = await ctx.reply('Поздравляем! Вы выполнили первое задание при входе в клуб! Нам нужно время, чтобы создать индивидуальное предложение для вас. Оставайтесь на связи! И если у вас есть вопросы - просто задавайте их в этом чате (только текстом).');
