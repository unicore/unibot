...
const quizDefinition = [
  { message: 'Contacts' },
  { message: 'Давайте познакомимся! Пожалуйста, расскажите кратко о себе и своих навыках в разработке ПО? Тогда мы сможем создать индивидуальное предложение по обучению для вас.' },
